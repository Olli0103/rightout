...
RightOut `0.2.0-rc.1` supports approval-gated, read-only scans of catalog entries whose `scan.supported` is `true`. It supports no removal submission, email, form, CAPTCHA, verification-link, scheduler, or provider-write capability.

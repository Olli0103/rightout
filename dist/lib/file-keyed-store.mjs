...
export function createEncryptedFileKeyedStore({ stateDir, namespace, maxEntries, defaultTtlMs = /** @type {number | undefined} */ (undefined), getSecret, now = () => Date.now(), _testHooks = undefined, }) {

...
export function parseRemovalProfile(value) {
    ...
    if (!profile || typeof profile !== "object" || Array.isArray(profile))
        throw new Error("profile_invalid");
    const allowed = new Set(["fullName", "city", "region", "country", "contactEmail", "jurisdictions", "consent"]);
    ...
    return { fullName, city, region, country, contactEmail, jurisdictions, consent };
}
...
export function validateRemovalOperatorAttestations(input, value) {
    ...
    const authorizedBrokerIds = cleanStringArray(value.authorizedBrokerIds, "broker", SAFE_ID);

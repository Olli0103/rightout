...
- `openclaw.plugin.json` declares all ten registered tools, exact optional/replay metadata, lazy config signals, SecretInput paths, closed config schema, skill directory, and `onStartup: false`.

...
| Durable worker | encrypted state, live atomic leases, exact result receipts, checkpoints, backoff, session/policy binding, fail-closed schedule replacement, resume/revoke tests | passed |
...
| Evidence vault | encryption, content addressing, retention, tamper, serialized export/purge/rotation, approved export | passed |

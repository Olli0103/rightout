...
const TRANSITIONS = new Map([
  ...
  ["partially_removed", new Set(["action_selected", "submission_pending", "confirmed_removed", "reappeared", "human_task_queued", "blocked"])],
...
export function createCaseLedger(store, { now = () => new Date() } = {}) {
  ...
  async function reserveSubmission(profileId, brokerId, { channel, discoveryRequirement } = {}) {
    ...
    if (!["smtp_email", "browser_form"].includes(channel)) throw new Error("invalid_submission_channel");

...
export function approvalDescription(input) {
  ...
  return `P ${validated.profileId}; B ${validated.brokerIds.join(",")}. Search Brave index only (terms ${BRAVE_TERMS_VERSION}; logs <=90d unless ZDR). Send name+city+region+country. No broker fetch, storage, email, or write.`;
}

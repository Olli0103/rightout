...
| Cross-action widening | nine independent tool/policy/attestation bindings |
...
| Direct Gateway exposure | deny all nine approval-gated tools on `gateway.tools.deny`; audit otherwise |
